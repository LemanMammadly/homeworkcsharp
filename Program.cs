...
namespace homework
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region task1
            //Gonderilmis 3 ededin en boyuyunu tapib qaytaran metod -3 integer parametr qebul
            //edir ve iclerinde en boyuk hansidirsa onu tapib return edir 
            ...
            #region task2
            //Gonderilmis ededin reqemlerinin cemini qaytaran metod -misalcun bu metodu call ederken
            //arqument olaraq 451 gondersek metoddan geriye 10 qayitmalidir
            ...
            #region task3
            //Supermarketdə belə bir aksiya keçirilir: “İstənilən iki mal alana üçüncüsü pulsuz verilir, ancaq
            //seçilmiş 3 maldan iki ən bahalısının qiyməti ödənilir”.Alınacaq 3 məhsulun qiyməti
            //verilmişdirsə ödəniləcək məbləği hesbalayan metod yazin - yəni metodunuz 3 doubel parameter qebul
            //edib en boyuk ikisinin cemini hesablayib qaytarmalidir
            ...
            #region task4-
            //Ədədlərdən ibarət array qəbul edən
            //method yazın.Array sort metoduna uyğun CustomSort(int[] arr)
            //metodunu yazın. Hazir Sort Methodunu Isletmek Olmaz.
            ...
            #region task5-
            //Stringlerden ibaret array-i və char qəbul edən metod yazın.Arrayin
            //hansi index-də bu qəbul
            //edilən char varsa, o string-ləri array seklinde geri qaytaran method.
